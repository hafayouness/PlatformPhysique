...
//     //   },
//     // ]);
//     // ── 2BAC Sciences Mathématiques (SM) ───────────────────────────
//     const cSM = await Course.bulkCreate([
//       {
//         title: "Mécanique — Dynamique du point",
//         description: "Lois de Newton et principe fondamental de la dynamique.",
//         level: "2bac",
//         chapter: "Mécanique",
//         filiere: "SM",
//       },
...
//         title: "Mécanique — Travail et énergie",
//         description:
//           "Travail d'une force, énergie cinétique et énergie mécanique.",
//         level: "2bac",
//         chapter: "Mécanique",
//         filiere: "SM",
//       },
//       {
//         title: "Mécanique — Oscillations mécaniques",
//         description: "Pendule simple, ressort et oscillations mécaniques.",
//         level: "2bac",
//         chapter: "Ondes",
//         filiere: "SM",
//       },
//       {
//         title: "Mécanique — Chute libre et plan incliné",
//         description: "Étude des mouvements, trajectoires et forces.",
//         level: "2bac",
//         chapter: "Mécanique",
//         filiere: "SM",
//       },
//       {
//         title: "Électricité — Circuits RC et RL",
//         description: "Régimes transitoires, condensateur et bobine.",
//         level: "2bac",
//         chapter: "Électricité",
//         filiere: "SM",
//       },
//       {
//         title: "Électricité — Circuit RLC",
//         description: "Oscillations électriques et circuit RLC.",
//         level: "2bac",
//         chapter: "Électricité",
//         filiere: "SM",
//       },
...
//       {
//         title: "Chimie — Transformations acido-basiques",
//         description: "pH, acides, bases et titrages.",
//         level: "2bac",
//         chapter: "Chimie",
//         filiere: "SM",
//       },
//       {
//         title: "Chimie — Oxydoréduction",
//         description: "Couples oxydant/réducteur et réactions redox.",
//         level: "2bac",
//         chapter: "Chimie",
//         filiere: "SM",
//       },
//       {
//         title: "Chimie — Chimie organique",
//         description: "Alcools, acides carboxyliques et esters.",
//         level: "2bac",
//         chapter: "Chimie",
//         filiere: "SM",
//       },
//     ]);
//     const totalCours = c1bac.length + cSP.length + cSVT.length + cSM.length;
//     console.log(
//       `📚 [2/4] Cours créés : 1BAC(${c1bac.length}) + SP(${cSP.length}) + SVT(${cSVT.length}) + SM(${cSM.length})  = ${totalCours} cours`,
//     );
...
//     // ── SMA Ch1 : Dynamique ────────────────────────────────────────
//     const [, , ex1_sm1, ex2_sm1] = await addResources(cSM[0], [
//       {
//         title: "Cours PDF — Dynamique newtonienne (SM)",
//         type: "pdf",
//         fileUrl: "/uploads/pdf/sm-ch1-cours.pdf",
//         isFree: true,
//       },
//       {
//         title: "Résumé — Lois de Newton SM",
//         type: "resume",
//         fileUrl: "/uploads/resume/sm-ch1-resume.pdf",
//         isFree: true,
//       },
//       {
//         title: "Exercice 1 — Système mécanique complexe",
//         type: "exercise",
//         fileUrl: "/uploads/exercise/sm-ch1-ex1.pdf",
//         isFree: true,
//       },
//       {
//         title: "Exercice 2 — Application forces multiples",
//         type: "exercise",
//         fileUrl: "/uploads/exercise/sm-ch1-ex2.pdf",
//         isFree: false,
//       },
//       {
//         title: "Vidéo — Dynamique SM approfondie",
//         type: "video",
//         fileUrl: "/uploads/video/sm-ch1-video.mp4",
//         isFree: false,
//       },
//     ]);
//     await Resource.bulkCreate([
...
//         title: "Correction Ex1",
//         type: "solution",
//         fileUrl: "/uploads/solution/sm-ch1-sol1.pdf",
//         courseId: cSM[0].id,
//         linkedResourceId: ex1_sm1.id,
//         order: 6,
//         isFree: true,
//       },
//       {
//         title: "Correction Ex2",
//         type: "solution",
//         fileUrl: "/uploads/solution/sm-ch1-sol2.pdf",
//         courseId: cSM[0].id,
//         linkedResourceId: ex2_sm1.id,
//         order: 7,
//         isFree: false,
//       },
//     ]);
...
//     // ── SMB Ch1 : Dynamique ────────────────────────────────────────
//     const [, , ex3_sm3, ex4_sm4] = await addResources(cSM[0], [
//       {
//         title: "Cours PDF — Dynamique du point (SM)",
//         type: "pdf",
//         fileUrl: "/uploads/pdf/sm-ch1-cours.pdf",
//         isFree: true,
//       },
//       {
//         title: "Résumé — Newton SM",
//         type: "resume",
//         fileUrl: "/uploads/resume/sm-ch1-resume.pdf",
//         isFree: true,
//       },
...
//     for (const filiere of ["SP", "SVT", "SM"]) {
...
//     console.log(
//       `📋 [4/4] Examens nationaux créés : ${exams.length} examens (SP + SVT + SM — 2015 à 2024)`,
//     );
