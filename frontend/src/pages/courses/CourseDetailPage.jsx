...
import ResourceRow from "../../components/shared/ResourceRow";
  ...
  if (isLoading)
    return (
      <div
        ...
        style={{ background: "#f5f5f7", fontFamily: "'DM Sans', sans-serif" }}
      >
        <div
          style={{
            background: "#fff",
  ...
  return (
    <>
      <style>{`
        ...
        .cdp-tab.active .cdp-tab-count { background: rgba(255,255,255,0.3); }
